...
public final class FragmentColorDisplayBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentColorDisplayBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentColorDisplayBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_color_display, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentColorDisplayBinding bind(@NonNull View rootView) {
